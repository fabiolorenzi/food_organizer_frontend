...
SOURCES       = src/main.cpp \
		src/classes/MainWindow.cpp moc_MainWindow.cpp
OBJECTS       = main.o \
		MainWindow.o \
		moc_MainWindow.o
DIST          = /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		food_organizer_frontend.pro src/classes/MainWindow.h src/main.cpp \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents src/classes/MainWindow.h $(DISTDIR)/
	$(COPY_FILE) --parents src/main.cpp src/classes/MainWindow.cpp $(DISTDIR)/
